...
@section('meta_title', "Edit Role - Verma Courier's Admin")
                                ...
                                <div class="card border-btm">
                                    <div class="card-header">
                                        <div class="title-icon">
                                            <span><img src="{{ asset('img/icons/icon-01.png') }}" alt="edit role"></span>
                                            Edit Role
                                        </div>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <div class="col-sm-6 col-md-4 col-12">
                                                    <div class="custom-field @error('name') has-validation @enderror">
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('name', $role->name) }}" @readonly($role->name != '')>
                                                    ...
                                                    <div
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            @foreach ($status_list as $id => $value)
                                                                <option value="{{ $id }}"
                                                                    @if ($id == $role->status) selected @endif>
                                                                    {{ $value }}
                                                                </option>
                                                            @endforeach
                                                        </select>
