...
@section('meta_title', "Edit Location - Verma Courier's Admin")
            ...
            <section class="right-section">
                <div class="scroller">
                    <div class="page-wrap">
                        <div class="nav-back">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('locations.index') }}">Location
                                            Managment</a>
                                    </li>
                        ...
                        <form action="{{ route('locations.update', $location->id) }}" method="POST" autocomplete="off">
                            @csrf
                            @method('PATCH')
                            <section>
                                                    ...
                                                    <div
                                                        ...
                                                        <select name="status" id="status"
                                                            ...
                                                            @foreach ($status_list as $id => $value)
                                                                <option value="{{ $id }}"
                                                                    @if ($id == $location->status) selected @endif>
                                                                    {{ $value }}
                                                                </option>
                                                            @endforeach
                                                        </select>
